...
def display_dropdown(object, self): #Function that displays the dropdown to choose the business object
    if object.prior_error == False:
        ...
        self.confirmObjectBTN = Button(self.middle_wrapper, text="Confirm Business Object Choice", fg="white", bg="#990000", command=lambda: BO.check_columns(object, objectChoice, self))
